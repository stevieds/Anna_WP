...
function hello_fashion_styles() {
    ...
    // bootstrap 
    wp_enqueue_style( 'bootstrap', get_stylesheet_directory_uri(). '/bootstrap/css' . $build . '/bootstrap' . $suffix . '.css', array(), null );
    wp_enqueue_script( 'bootstrap', get_stylesheet_directory_uri() . '/bootstrap/js' . $build . '/bootstrap.bundle' . $suffix . '.js', array(), null, true );
...
function vilva_header(){ 
    ...
    <?php } else { ?>
        ...
        <nav class="navbar navbar-expand-md navbar-light sticky-top" style="background-color:#ffffffe0;">
                <div class="container-fluid">
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
                    <a class="navbar-brand" href="#">
                        <img src="http://localhost/anna_wp/wp-content/uploads/2022/02/logo_fucsia.png" alt="" width="100">
                    </a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="#cosa-faccio">Cosa faccio</a>
                        </li>

                        <li class="nav-item">
                        <a class="nav-link" href="#dove">Dove sono</a>
                        </li>

                        <li class="nav-item">
                        <a class="nav-link" href="#contatta">Contattami</a>
                        </li>
    ...
    <div class="footer-b">
        <div class="container">
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-3">© Copyright 2022 - by <a href="mailto:stevie.de.simone1@gmail.com">Stevie de Simone</a></div>
                <div class="col-md-1"><a href="cookies" target="_blank">COOKIES</a></div>
                <div class="col-md-1 offset-md-4 footer-social"><?php vilva_social_links(); ?></div>
            </div>
